...
class MySpider(object):
    ...
    def __process_titles_page(self, page_url):
        req = self.requests.get(page_url, headers=headers)
        content = req.content
        print content
        # soup = BeautifulSoup(content)
        # print soup.contents
    ...
    def main(self):
        self.__process_titles_page(self.start_url)
        '''
...
my_url = 'http://gz.sina.com.cn/news/msrd/list.shtml'
spider = MySpider(my_url)
